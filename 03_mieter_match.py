...
def write_output_csv(output: pd.DataFrame) -> Path:
    """Schreibt Ergebnisdatei robust, auch wenn die Zieldatei gesperrt ist."""
    DATA_DIR.mkdir(exist_ok=True)
    tmp_path = OUTPUT_PATH.with_name(f"{OUTPUT_PATH.stem}__tmp.csv")
...
def main() -> None:
    ...
    written_path = write_output_csv(output)
